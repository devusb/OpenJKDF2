...
if(NOT FreeGLUT_FOUND OR CMAKE_CROSSCOMPILING)
    if(TARGET_USE_SYSTEM_LIBS)
        # Engine never actually links GLUT::GLUT on Linux; the find_package +
        # ExternalProject fallback only existed so FreeGLUT_FOUND would be true.
        # Skip the fallback entirely when consuming system libs.
    else()
...
if(NOT CMAKE_CROSSCOMPILING AND NOT TARGET_LINUX_64_GLES)
    find_package(GLEW 2.2.0)
endif()
if((NOT GLEW_FOUND OR CMAKE_CROSSCOMPILING) AND NOT PLAT_WASM AND NOT TARGET_USE_OPENGL11 AND NOT TARGET_LINUX_64_GLES)
...
# SDL2 + SDL_mixer (vendored submodule build, or system libs)
if(TARGET_USE_SDL2 AND NOT PLAT_WASM)
    if(TARGET_USE_SYSTEM_LIBS)
        ...
        if(TARGET_USE_OPENAL)
            ...
            # Vendored SDL_mixer pulled in vorbis/ogg/opus statics via this var;
            # the shared system build has them transitively, so nothing to add.
            set(SDL_MIXER_DEPS "")
        endif()
    else()
